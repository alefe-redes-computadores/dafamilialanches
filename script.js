...
(function () {
  ...
  // ---------- LOGIN: toast ao autenticar ----------
  function wireLoginToast() {
    try {
    ...
    // Caso seu código de login dê um dispatch manual:
    window.addEventListener('dfl:login-success', () => {
      showToast('🎉 Login realizado com sucesso!');
    });
  }

  // ---------- MINIATURAS EM "MEUS PEDIDOS" ----------
  const THUMB_MAP = [
    // Combos/Promo
    { re: /\bcombo\b|\bpromo(ção|coes|coes|cao|ções)?\b/i, img: 'promocoes/promo1.jpg' },
    { re: /\bcasal\b/i,                          img: 'imagens/combo1.png' },
    { re: /\bfam(í|i)lia\b/i,                    img: 'imagens/combo3.png' },
    // Tradicionais
    { re: /\bb(ã|a)o\b/i,                        img: 'imagens/bao.png' },
    { re: /\buai\b/i,                             img: 'imagens/uai.png' },
    { re: /\btrem\b/i,                            img: 'imagens/trem.png' },
    { re: /\bcadim\b/i,                           img: 'imagens/cadim.png' },
    { re: /\barmaria\b/i,                         img: 'imagens/armaria.png' },
    { re: /\bbitela\b/i,                          img: 'imagens/bitela.png' },
    { re: /\bapruma\b/i,                          img: 'imagens/apruma.png' },
    // Artesanais
    { re: /\bpeleja\b/i,                          img: 'imagens/peleja.png' },
    { re: /\btudibom\b/i,                         img: 'imagens/tudibom.png' },
    { re: /\bcustoso\b/i,                         img: 'imagens/custoso.png' },
    // Hot dogs
    { re: /\bnigucim\b/i,                         img: 'imagens/nigucim.png' },
    { re: /\bsimpr(a|ã)o\b|\bsimprao\b/i,         img: 'imagens/simprao.png' },
    { re: /\bnimin\b/i,                           img: 'imagens/nimin.png' },
    { re: /\bpadan(a|á)\b/i,                      img: 'imagens/padana.png' },
    { re: /\bpurizin\b/i,                         img: 'imagens/purizin.png' },
    { re: /\btremb(a|ã)o\b|\btrembao\b/i,         img: 'imagens/trembao.png' },
  ];

  function pickThumb(text) {
    if (!text) return null;
    for (const r of THUMB_MAP) {
      if (r.re.test(text)) return r.img;
    }
    return null;
  }
  ...
  function ensureThumb(el) {
    ...
    if (el.querySelector('.dfl-thumb')) return; // já tem
